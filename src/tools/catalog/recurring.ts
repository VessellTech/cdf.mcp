...
export const recurringTools: ToolDef[] = [
  ...
  },
  {
    ...
    path: "/api/recurring-transactions",
    input: {
      type: z.enum(["EXPENSE", "INCOME"]).describe("Tipo de cada ocorrência gerada"),
      amount: z.number().describe("Valor de cada ocorrência gerada"),
      description: z.string().describe("Descrição de cada ocorrência gerada"),
      ...
      costCenterId: z.string().optional().describe("Centro de custo aplicado a cada ocorrência gerada"),
  ...
  },
  {
    ...
    input: {
      ...
      type: z.enum(["EXPENSE", "INCOME"]).optional().describe("Tipo das ocorrências futuras"),
      ...
      description: z.string().optional().describe("Nova descrição das ocorrências futuras"),
      ...
      accountId: z.string().optional().describe("Nova conta usada para débito/crédito"),
      cardId: z.string().optional().describe("Novo cartão usado para ocorrências EXPENSE"),
      destinationAccountId: z.string().optional().describe("Nova conta de destino, se as ocorrências forem transferências"),
